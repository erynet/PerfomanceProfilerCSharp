...
namespace Direct3DHookLib
{
    ...
    public class EntryPoint: EasyHook.IEntryPoint
    {
        ...
        private bool InitialiseDirectXHook(CaptureConfig config)
        {
            ...
            //prop["pid"] = EasyHook.RemoteHooking.GetCurrentProcessId();
            //System.Console.WriteLine("InitialiseDirectXHook");
            ...
            try
            {
                if (version == Direct3DVersion.AutoDetect)
                {
                    ...
                    if (d3D11_1Loaded != IntPtr.Zero)
                    {
                        ...
                        _interface.ReportProperty(EasyHook.RemoteHooking.GetCurrentProcessId(), (float)11.1);
                        System.Console.WriteLine("11.1");
                    ...
                    if (d3D11Loaded != IntPtr.Zero)
                    {
                        ...
                        _interface.ReportProperty(EasyHook.RemoteHooking.GetCurrentProcessId(), (float)11);
                    ...
                    if (d3D10_1Loaded != IntPtr.Zero)
                    {
                        ...
                        _interface.ReportProperty(EasyHook.RemoteHooking.GetCurrentProcessId(), (float)10.1);
                    ...
                    if (d3D10Loaded != IntPtr.Zero)
                    {
                        ...
                        _interface.ReportProperty(EasyHook.RemoteHooking.GetCurrentProcessId(), (float)10);
                    ...
                    if (d3D9Loaded != IntPtr.Zero)
                    {
                        ...
                        _interface.ReportProperty(EasyHook.RemoteHooking.GetCurrentProcessId(), (float)9);
